...
class ArtistForNotes(NotesTemplate):
    ...
    def getAllSteppers(self):
        ...
        try:
            ...
            print(logMsg("ARTISTFORNOTES", "ERROR"), "getAllSteppers: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                      str(sys.exc_info()[1])))
    ...
    def getJudgeFilesForAdd(self):
        ...
        try:
            ...
            print(logMsg("ARTISTFORNOTES", "ERROR"), "getJudgeFilesForAdd: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                            str(sys.exc_info()[1])))
    ...
    def getJudgeName(self, notesFileName):
        ...
        """
        print(logMsg("ARTISTFORNOTES", "INFO"), "getJudgeName: Retrieving Judge Name from Notes File '"
              + notesFileName + "'")
        try:
            ...
            print(logMsg("ARTISTFORNOTES", "ERROR"), "getJudgeName: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                     str(sys.exc_info()[1])))
    ...
    def getAllJudgesInSet(self):
        ...
        try:
            ...
            print(logMsg("ARTISTFORNOTES", "ERROR"), "getAllJudgesInSet: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                         str(sys.exc_info()[1])))
    ...
    def addStepArtistToLine(self, ratingLine, fileIndex):
        ...
        try:
            ...
            print(logMsg("ARTISTFORNOTES", "ERROR"), "addStepArtistToLine: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                           str(sys.exc_info()[1])))
    ...
    def addSteppersToFile(self):
        ...
        try:
            ...
            print(logMsg("ARTISTFORNOTES", "ERROR"), "addSteppersToFile: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                          str(sys.exc_info()[1])))
