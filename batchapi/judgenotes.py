    ...
    * FUNCTIONS *
    ...
    def getJudgeName(self):
        ...
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "getJudgeName: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                 str(sys.exc_info()[1])))
    ...
    def getRatingWithInfo(self, ratingLine):
        ...
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "getRatingWithInfo: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                      str(sys.exc_info()[1])))
    ...
    def handleSpecialRating(self, symbol, lineToParse):
        ...
        try:
            ...
            if ratingStepartist is not None:
                print(logMsg("JUDGENOTES", "INFO"), "handleSpecialRating: Found rating with stepartist on special "
                                                    "rating '" + symbol + "'")
                # ratingStepartist.group(0) # Full match
                ...
                print(logMsg("JUDGENOTES", "INFO"), "handleSpecialRating: Found rating without stepartist on special "
                                                    "rating '" + symbol + "'")
                # ratingNoStepartist.group(0) # Full Match
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "handleSpecialRating: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                        str(sys.exc_info()[1])))
    ...
    def printJudgeRatings(self):
        ...
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "printJudgeRatings: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                      str(sys.exc_info()[1])))
    ...
    def getJudgeAverage(self):
        ...
        try:
            ...
            print(logMsg("JUDGENOTES", "INFO"), "getJudgeAverage:", ratingSum, "/", self.numJudgedFiles, "=",
                  self.average)
        except:
            print(logMsg("JUDGENOTES", "ERROR"), "getJudgeAverage: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                    str(sys.exc_info()[1])))
    ...
    def getRawRatings(self):
        ...
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "getRawRatings: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                  str(sys.exc_info()[1])))
    ...
    def getRawSpecialRatings(self):
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "getRawSpecialRatings: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                        str(sys.exc_info()[1])))
    ...
    def printRawRatings(self):
        ...
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "printRawRatings: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                    str(sys.exc_info()[1])))
    ...
    def getRatingsToSongs(self):
        ...
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "getRatingsToSongs: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                     str(sys.exc_info()[1])))

    def getSpecialRatingsToSongs(self):
        print(logMsg("JUDGENOTES", "INFO"), "getSpecialRatingsToSongs: Generating Dictionary for Special Ratings --> "
                                            "Songs")
        try:
            for ratingTuple in self.specialSongList:
                keyForDict = ratingTuple[1]
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "getSpecialRatingsToSongs: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                            str(sys.exc_info()[1])))
    ...
    def printRatingsToSongs(self):
        ...
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "printRatingsToSongs: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                        str(sys.exc_info()[1])))
    ...
    def writeRawRatings(self):
        ...
        """
        print(logMsg("JUDGENOTES", "INFO"), "writeRawRatings: Writing file containing songs for each rating")
        try:
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "writeRawRatings: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                    str(sys.exc_info()[1])))
    ...
    def writeRatingsToSongs(self):
        ...
        """
        print(logMsg("JUDGENOTES", "INFO"), "writeRatingsToSongs: Writing file containing songs for each rating")
        try:
            os.chdir(self.fileDir)
            sortedRatings = sorted(self.ratingsToSongs.keys(), key=float)
            ...
            print(logMsg("JUDGENOTES", "ERROR"), "writeRatingsToSongs: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                        str(sys.exc_info()[1])))
    ...
    def printJudgeAverage(self):
        ...
        """
        print(logMsg("JUDGENOTES", "INFO"), "printJudgeAverage: '" + str(self.average) + "' Judge Average from '"
              + self.notesFile + "'")
    ...
    def printNumOfJudgedFiles(self):
        ...
        """
        print(logMsg("JUDGENOTES", "INFO"), "printNumOfJudgedFiles:", self.numJudgedFiles, "files judged from '"
              + self.notesFile + "'")
