...
- JUDGE NAMES: {}""" \
    ...
    def getJudgeName(self, notesFileName):
        ...
        try:
            ...
            print(logMsg("JUDGETOEXCEL", "ERROR"), "getJudgeName: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                   str(sys.exc_info()[1])))
    ...
    def getAllJudgesInSet(self):
        ...
        try:
            ...
            print(logMsg("JUDGETOEXCEL", "ERROR"), "getAllJudgesInSet: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                        str(sys.exc_info()[1])))
    ...
    def getSetFileListing(self):
        print(logMsg("JUDGETOEXCEL", "INFO"), "getSetFileListing: Attempting to get list of judge notes files for this "
                                              "set '" + self.path + "'")
        try:
            self.notesFiles = os.listdir(self.path)
        except:
            print(logMsg("JUDGETOEXCEL", "ERROR"), "getSetFileListing: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                        str(sys.exc_info()[1])))
    ...
    def getSongWithStepartist(self,ratingLine):
        ...
        try:
            ...
            print(logMsg("JUDGETOEXCEL", "ERROR"), "getSongTitle: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                   str(sys.exc_info()[1])))
    ...
    def getOrderedSongList(self):
        ...
        """
        print(logMsg("JUDGETOEXCEL", "INFO"), "getOrderedSongList: Attempting to get ordered song list of set '"
              + self.setName + "'")
        try:
            ...
            print(logMsg("JUDGETOEXCEL", "ERROR"), "getOrderedSongList: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                         str(sys.exc_info()[1])))
    ...
    def getSimpleRating(self,ratingLine):
        ...
        try:
            ...
            print(logMsg("JUDGETOEXCEL", "ERROR"), "getSimpleRating: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                      str(sys.exc_info()[1])))
    ...
    def getRatingsFromJudge(self, judge):
        ...
        try:
            ...
            print(logMsg("JUDGETOEXCEL", "ERROR"), "getRatingsFromJudge: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                          str(sys.exc_info()[1])))
    ...
    def getAllJudgeRatings(self):
        ...
        print(logMsg("JUDGETOEXCEL", "INFO"), "getAllJudgeRatings: Attempting to get ratings from all judges for set '"
              + self.setName + "'")
        try:
            for judgeName in self.judgeNames:
                self.judgeToRating[judgeName] = self.getRatingsFromJudge(judgeName)
        except:
            print(logMsg("JUDGETOEXCEL", "ERROR"), "getAllJudgeRatings: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                         str(sys.exc_info()[1])))
    ...
    def createRatingCSV(self):
        ...
        try:
            ...
            print(logMsg("JUDGETOEXCEL", "ERROR"), "createRatingCSV: {0}: {1}".format(sys.exc_info()[0].__name__,
                                                                                      str(sys.exc_info()[1])))
